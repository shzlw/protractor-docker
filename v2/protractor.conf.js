...
exports.config = {
    ...
    specs: [
        '/usr/src/app/cucumber/*.feature' // Specs here are the cucumber feature files
    ],
    // cucumber command line options
    cucumberOpts: {
        require: [
            //'take-screenshot.js',
            '/usr/src/app/cucumber/*.js',
    ...
    onComplete: () => {
        ...
        const options = {
            theme: 'bootstrap',
            jsonFile: '/usr/src/app/cucumber_report.json',
            output: `/usr/src/app/public/${id}/cucumber_report.html`,
